...
namespace MovieProject.Controllers
{
    public class CastsController : Controller
    {
        ...
        public CastsController(MovieProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Cast cast)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Cast cast)
        {
            if (id != cast.Id)
            {
                return NotFound();
